<div>
    ...
    <div class="grid grid-cols-2 gap-0 border-t border-l border-gray-300">
        ...
        <a href="#"
            ...
            <span class="font-medium mb-2">Elektrifizierung der Bahnlinie</span>
            <p>Damit Simbach nicht abgehängt wird.</p>
        </a>
        <a href="#"
            class="hover:bg-gray-100 cursor-pointer p-4 border-b border-r border-gray-300 text-center flex flex-col">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor"
            ...
            <span class="font-medium mb-2">Autobahn A94</span>
            <p>Keine offene Autobahn in Simbach am Inn.</p>
        </a>
        <a href="#"
            class="hover:bg-gray-100 cursor-pointer p-4 border-b border-r border-gray-300 text-center flex flex-col">
            ...
            <span class="font-medium mb-2">Stadtentwicklung</span>
            <p>Ideen und Konzepte für unsere Stadt von morgen</p>
        </a>
    </div>
