                ...
                {{-- <div class="flex items-center gap-2"> --}}
                    ...
                    @if ($event->end_date)
                        <div class="flex items-center gap-3">
                            ...
                            <span
                                class="text-gray-900">
                                {{ $event->localized_start_date?->isoFormat('DD. MMMM YYYY') }} - {{ $event->localized_end_date?->isoFormat('DD. MMMM YYYY') }}
                            </span>
                        </div>
                    @else
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <span
                                class="text-gray-900">{{ $event->localized_start_date?->isoFormat('DD. MMMM YYYY') }}</span>
                            @if ($event->start_time)
                                <time datetime="{{ $event->start_time?->format('H:i') }}"
                                    class="text-gray-900">{{ $event->start_time_display }} Uhr</time>
                            @endif
                        </div>
                    @endif 
