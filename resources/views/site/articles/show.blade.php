<x-layout.app :title="$item->title">
    <article class="max-w-4xl mx-auto px-6 py-16">
        <header class="mb-12">
            ...
            @if($item->teaser)
                <p class="text-xl text-gray-700 leading-relaxed font-medium mb-8 border-l-4 border-primary pl-6 italic">
                    {{ $item->teaser }}
                </p>
            @endif
        </header>
        ...
        <footer class="mt-16 pt-8 border-t border-gray-200">
            <a href="{{ route('articles.index') }}" class="inline-flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all">
